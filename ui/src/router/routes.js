...
import BizTableBasic from '../views/biz/BizTableBasic';
import BizTableEdit from '../views/biz/BizTableEdit';
import BizTableSearch from '../views/biz/BizTableSearch';
import BizLineChart from '../views/biz/BizLineChart';
...
export const routes = [
	...
	{ path: '/biz/user', component: BizTableEdit },
	{ path: '/biz/userline', component: BizLineChart }	
];
